...
const Recommended = () => {
    ...
    return (
        <div className="recommend_layout">
            ...
            <img alt = "a young orangutan in a tree" src="https://www.orangutan.org.au/static/media/uploads/adoption/mary_adoption727x727.jpg" />
            ...
            <a href = "http://www.tigerhaven.org/index.asp" target="_blank">
                <img alt="Close-up of tiger, looking at camera" src="https://static.scientificamerican.com/sciam/cache/file/5C51E427-1715-44E6-9B14D9487D7B7F2D_source.jpg" />
                <div className="textbox">
                    <p>{charity2.name}</p>
                    <p>{charity2.cause}</p>
            ...
            <a href = "https://www.pandasinternational.org/" target="_blank">
                <img alt="A panda eating bamboo" src="https://media.tacdn.com/media/attractions-splice-spp-674x446/07/26/3c/87.jpg" />
                <div className="textbox">
                    <p>{charity3.name}</p>
                    <p>{charity3.cause}</p>
            ...
            <a href = "https://rhinos.org/" target="_blank">
                <img alt="A rhino in side profile" src="https://www.eurekalert.org/multimedia/pub/web/221627_web.jpg" />
                <div className="textbox">
                    <p>{charity4.name}</p>
                    <p>{charity4.cause}</p>
            ...
            <a href = "https://gorillafund.org/" target="_blank">
                <img alt="Close-up of gorilla, looking at camera" src="https://i.natgeofe.com/n/23a85f5b-32be-4bc1-af13-3e1a403b8557/mountain-gorilla_thumb.jpg" />
                <div className="textbox">
                    <p>{charity5.name}</p>
                    <p>{charity5.cause}</p>
            ...
            <a href = "https://www.elephants.com/" target="_blank">
                <img alt="An elephant in side profile" src="https://images.theconversation.com/files/230552/original/file-20180803-41366-8x4waf.JPG?ixlib=rb-1.1.0&q=45&auto=format&w=926&fit=clip" />
                <div className="textbox">
                    <p>{charity6.name}</p>
                    <p>{charity6.cause}</p>
            ...
            <a href = "https://polarbearsinternational.org/" target="_blank">
                <img alt="A polar bear and cubs" src="https://c402277.ssl.cf1.rackcdn.com/photos/18694/images/carousel_small/Polar_bear_with_cubs_in_Wapusk_WW266666.jpg?1582733801" />
                <div className="textbox">
                    <p>{charity7.name}</p>
                    <p>{charity7.cause}</p>
            ...
            <a href = "https://www.otter.org/Public/Default.aspx" target="_blank">
                <img alt="An otter in side profile" src="https://www.nature.scot/sites/default/files/styles/hero_banner_half_width/public/2017-07/Otter-01v2.jpg?itok=WcsIZM11" />
                <div className="textbox">
                    <p>{charity8.name}</p>
                    <p>{charity8.cause}</p>
